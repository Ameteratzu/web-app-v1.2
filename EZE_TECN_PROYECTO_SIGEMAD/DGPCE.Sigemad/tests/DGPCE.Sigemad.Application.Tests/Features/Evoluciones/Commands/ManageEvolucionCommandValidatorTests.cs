...
{
    private readonly ManageEvolucionCommandValidator _validator;
    ...
    public ManageEvolucionCommandValidatorTests()
    {
        ...
        _validator = new ManageEvolucionCommandValidator(_localizer);
    }
    ...
    {
        // Arrange
        var command = new ManageEvolucionCommand { IdSuceso = 0 };
    ...
    {
        // Arrange
        var command = new ManageEvolucionCommand { IdSuceso = 1 };
    ...
    {
        // Arrange
        var command = new ManageEvolucionCommand { Registro = null };
    ...
    {
        // Arrange
        var command = new ManageEvolucionCommand { DatoPrincipal = null };
    ...
    {
        // Arrange
        var command = new ManageEvolucionCommand { Parametro = null };
