...
using DGPCE.Sigemad.Application.Features.Ope.OpePeriodos.Queries.GetOpePeriodosList;
using DGPCE.Sigemad.Application.Features.Ope.OpePeriodos.Vms;
using DGPCE.Sigemad.Application.Features.Ope.OpePeriodos.Commands.DeleteOpePeriodos;
using DGPCE.Sigemad.Application.Features.Ope.OpePeriodos.Queries.GetOpePeriodoById;
